...
public class WorkerRunnable implements Runnable {
	...
	public void run() {
		...
		try {
			...
			// Méthode bloquante : Tant qu'on ne reçoit pas de message, le Worker reste bloqué à cet endroit
			// C'est pour cela que ce serveur est multithreading : Chaque client est bloquant, ce qui
			// veut dire qu'un serveur non multithreading n'est capable de gérer qu'un seul client à la fois
			...
			// La connexion a été coupée d'un coup (erreur de connexion, time out, arrêt forcé du client)
